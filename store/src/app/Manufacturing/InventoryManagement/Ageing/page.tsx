...
const ManufacturingProductList = () => {
        ...
        const fetchProducts = async () => {
            try {
                ...
                if (response.data.success) {
                    ...
                    // Filter products added in the last year
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <h1 className="text-2xl font-bold mb-4">Top 12 Month Old Items</h1>
                ...
                <tbody>
                    {products.map((product, index) => (
                        <tr key={product._id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-2 border">{new Date(product.date).toLocaleDateString()}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
