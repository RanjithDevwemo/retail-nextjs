...
// // import bgImg from '@/app/Assets/toppng.com-stripes-pattern-470x402.png'
...
// //         <form className='col-sub-1'>
// //         <h2>ADMIN</h2>
// //             <h4>Hello</h4>
// //             <h1>Welcome</h1>
// //             <div className="input">
// //             <input placeholder='User name'/><FaUser className='icon'/>
// //             </div>
// //             <div className="input">
// //             <input placeholder='Password'></input> <FaLock className='icon'/> 
// //             </div>
// //             <div className="sub-links">
// //             <p className="">Forget Password</p>
// //             <p className="p2">Dont't You Have account ?</p>
...
//                         <div className="sub-links">
//                             <p className="">Forget Password</p>
//                             <p className="p2">Don't You Have an account?</p>
//                         </div>
//                         <div className='but'>
