...
app.post('/api/addproduct', async (req, res) => {
    try {
        ...
        // Basic validation
        if (!name || !image || !category || !price || !sku || !gst || !description || !stock || !ventorId || !godown || !reorderPoint) {
        ...
        if (stock > 0) {
            ...
            const product = new Product({
                ...
                stock,
                ventorId,
                reorderPoint, // Include reorderPoint
                finalPrice
            });
...
analys all code and rewrite it add stocks in seperately 
godown vice add total number of stock in model 
write code in dynamically