...
//         {/* Graph Container */}
//         <div className="bg-white p-5 rounded-xl shadow-md flex flex-col justify-between items-center h-40 w-full md:w-64">
//           <Graph />
//         </div>
...
//         <div className="bg-white p-5 rounded-xl shadow-md flex flex-col justify-center items-center h-40 w-full md:w-64">
